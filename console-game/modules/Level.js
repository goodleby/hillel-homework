var Level = (function() {
    ...
    Level.prototype.getRandPos = function() {
        ...
        if(!this.path.some(item => item instanceof Grass)) throw new Error('There is no more empty space on the path');
    ...
    Level.prototype.spawnMonsters = function(monsters, amount) {
        ...
        for(let i = 0; i < amount; i++) {
            this.path[this.getRandPos()] = new monsters[getRandInt(monsters.length)](getRandInt(minLvl, maxLvl));
        }
    };
